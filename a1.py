...
# pos,pos_depth shows us where we're at now 

class BreadthFirstSearch:
    def __init__(self, start, goal, grid, path):
        self.pos = start    #Current position
        self.pos_str = str(start)
        self.pos_depth = 0    #no. of moves
        self.goal_str = str(goal)
        self.explored = {}   
        self.not_explored = {}
        self.not_explored[str(start)] = 0   #Start pos in not explored list
        self.grid = grid
        self.path = path
    ...
    def get_possible_moves(self):
        ...
        # Since all next possible moves have been determined,consider current location explored.
    ...
    def goal_found(self):
        if self.goal_str in self.not_explored:
            ...
            # self.explored[self.pos] = self.pos_depth +1
